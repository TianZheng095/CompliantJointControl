...
extend = [Nc5Np5_error_extend,Nc5Np8_error_extend,Nc5Np10_error_extend, ...
    Nc8Np8_error_extend,Nc8Np10_error_extend]';
figure(1);
plot3(Nc,Np,extend);title('max extended qd');

error = [Nc5Np5_error_rmse,Nc5Np8_error_rmse,Nc5Np10_error_rmse, ...
    Nc8Np8_error_rmse,Nc8Np10_error_rmse]';
figure(2);
plot3(Nc,Np,error);title('velocity error rmse (without where qdref>qdmax)');

time = [Nc5Np5_time_mean,Nc5Np8_time_mean,Nc5Np10_time_mean, ...
    Nc8Np8_time_mean,Nc8Np10_time_mean]';
figure(3);
