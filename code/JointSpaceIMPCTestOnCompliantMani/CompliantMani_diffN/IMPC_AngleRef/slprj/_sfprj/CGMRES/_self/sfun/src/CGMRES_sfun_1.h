#ifndef __CGMRES_sfun_h__
#define __CGMRES_sfun_h__
...
extern mxArray* load_CGMRES_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_CGMRES_optimization_info(void);
