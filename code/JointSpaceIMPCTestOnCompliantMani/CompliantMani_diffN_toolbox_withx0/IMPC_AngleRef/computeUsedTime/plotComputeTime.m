...
load('UsingTime_IMPC_Np10_Nc5.mat'); 
load('UsingTime_IMPC_Np10_Nc10.mat'); 
...
plot(t, [UsingTime_IMPC_Np10_Nc3(2,2:numPlot); ...
         UsingTime_IMPC_Np10_Nc5(2,2:numPlot); ...
         UsingTime_IMPC_Np10_Nc10(2,2:numPlot); ...
         UsingTime_IMPC_Np20_Nc10(2,2:numPlot); ...
         UsingTime_IMPC_Np20_Nc20(2,2:numPlot); ...
         UsingTime_IMPC_Np30_Nc10(2,2:numPlot); ...
         UsingTime_IMPC_Np30_Nc30(2,2:numPlot)]);
     
     
legend('Np=10;Nc=3','Np=10;Nc=5','Np=10;Nc=10','Np=20;Nc=10', 'Np=20;Nc=20', 'Np=30;Nc=10','Np=30;Nc=30');  
