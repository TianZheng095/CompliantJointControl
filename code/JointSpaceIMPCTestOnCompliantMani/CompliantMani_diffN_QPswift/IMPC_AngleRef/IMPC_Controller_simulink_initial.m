...
Q_const_pos_error= 1000;
Q_const_vel_error= 20;
Q_const_theta_error = 20;
R_const = 1;
...
% with qd constraints
in_A = [W1;-W1;W2;-W2;I_bar;-I_bar;eye(Nc);-1*eye(Nc)];
A_QP = in_A(:);
% [m,n]=size([W1;-W1;W2;-W2;I_bar;-I_bar;eye(Nc);-1*eye(Nc)]);
% A_QP = reshape([W1;-W1;W2;-W2;I_bar;-I_bar;eye(Nc);-1*eye(Nc)]',m*n,1);
