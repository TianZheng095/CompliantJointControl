...
subplot(2,1,1); 
plot(const_trans2degree*(q(1,1:n_plot)-Xr(1,1:n_plot)),'-r'); title('e of q');
subplot(2,1,2); 
plot(const_trans2degree*(qd(1,1:n_plot)-Xr(2,1:n_plot)),'-r'); title('e of qd');
...
subplot(3,1,1); 
plot(const_trans2degree*q(1,1:n_plot),'-r'); title('q');
hold on 
